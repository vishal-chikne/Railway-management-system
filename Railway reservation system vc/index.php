	...
	<div class="wrap">
		...
		<div class="span12 well">
			...
			<marquee behavior="scroll" id="marq"  scrollamount=3 direction="up" height="294px" onmouseover="nestop()" onmouseout="nestrt()">
				<div>
				<p><b> This website only made for project purpose only by vishal chikne. There is no proposal to extend to mail/express and superfast trains the flexi-fares currently applicable only to Rajdhani, Shatabdi and Duronto trains,  said Railways Minister Suresh Prabhu.</b></p>
				</br>
...
<footer >
		<div style="width:100%;">
			...
			<p class="text-right text-info">  email : vishalchikne1234@gmail.com</p>	
			</div>
			<div style="float:right;">
			<p class="text-right text-info">	Desinged By : VishalChikne</p>
			</div>
		</div>
		</footer>	</div>
